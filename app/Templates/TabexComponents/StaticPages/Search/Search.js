...
const Search = (props) => {
    ...
    return (
        <View
            style={[generalstyles.containerInner, { flex: 1, paddingLeft: sectionproperties.searchliststyle == 'Cards' ? 0 : 15, paddingRight: sectionproperties.searchliststyle == 'Cards' ? 0 : 15 }]}
        >
                    ...
                    >
                        <View
                            style={[
                                ...
                                {
                                    paddingHorizontal: sectionproperties.searchliststyle == 'Cards' ? 15 : 0,
                                },
                            ]}
                        >
                            <TouchableOpacity
                            ...
                            <View style={{ paddingTop: 15 }}>
                                {SearchHeaderMutationContext.data.data.products.length == 0 && (
                                    <View style={[generalstyles.allcentered, { height: 400 }]}>
                                        <Feather name="layers" size={30} style={{ color: sectionproperties.noprod_color, marginBottom: 10 }} />
                                        <Text style={[generalstyles.poppinsMedium, { color: sectionproperties.noprod_color, fontSize: 18 }]}>{lang.couldnotfindproduct}</Text>
                                    </View>
                                )}
                                {sectionproperties.searchliststyle == 'Vertical' &&
                                        ...
                                        return (
                                            ...
                                            >
                                                <View style={[generalstyles.flexRow, { marginBottom: 15 }]}>
                                                    ...
                                                    <View style={{ marginBottom: 'auto', marginTop: sectionproperties.showpricesection == 'Hide' ? 'auto' : 0, flex: 1 }}>
                                                        <Text
                                                            ellipsizeMode="tail"
                                                            numberOfLines={3}
                                                            style={[
                                                        ...
                                                        {sectionproperties.showpricesection == 'Show' && (
                                                            <View style={[generalstyles.flexRow, { alignItems: 'center', marginTop: 15 }]}>
                                                                <Text
                                                                    style={[
                                                                        {
                                ...
                                {sectionproperties.searchliststyle == 'Cards' && (
                                    <FlatList
                                        data={SearchHeaderMutationContext.data.data.products}
                                        scrollEnabled={false}
                                        vertical
                                        numColumns={2}
                                        key={2}
                                        renderItem={({ item, index }) => {
                                            return (
                                                ...
                                                >
                                                    <View style={[generalstyles.flexColumn, { marginBottom: 25 }]}>
                                                        <View
                                                            style={{
                                                                width: '100%',
                                                                height: 200,
