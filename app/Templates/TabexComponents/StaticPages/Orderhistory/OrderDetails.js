...
const OrderDetails = (props) => {
    ...
    const source = {
        html: fetchorderhistoryQueryContext?.data?.data?.ordershistory[orderindex]?.owner_notes,
    };
    return (
        <View
            style={[
                ...
                <View>
                    <View style={[generalstyles.containerInner, { marginBottom: 10 }]}>
                        {sectionproperties.showorderid == 'Show' && (
                            <View style={[generalstyles.allcentered, { flexDirection: 'row', marginBottom: sectionproperties.summary_style == 'Horizontal' ? 20 : 0 }]}>
                                <Text
                                    style={{
                                        textAlign: 'left',
                        ...
                        {!fetchCustomerStatusContext.isFetching &&
                            ...
                            sectionproperties.summary_style == 'Horizontal' && (
                        ...
                        {!fetchCustomerStatusContext.isFetching &&
                            ...
                            fetchCustomerStatusContext?.data?.data?.customer_statusArr.length != 0 &&
                            sectionproperties.showSummarySection == 'Show' &&
                            sectionproperties.summary_style == 'Vertical' && (
                                <View style={[generalstyles.flexColumn, { marginBottom: 10, width: '100%', position: 'relative', paddingHorizontal: 5 }]}>
                                    <FlatList
                                        // horizontal={true}
                                        data={statusArr}
                                        showsHorizontalScrollIndicator={false}
                                        ...
                                        renderItem={({ item, index }) => {
                                            if (item.active == 1) {
                                                return (
                                                    <View style={[generalstyles.flexRow, { paddingTop: 3 }]}>
                    ...
                    <View>
                            ...
                            style={[
                                generalstyles.containerInner,
                                {
                                    ...
                                    display:
                                        ...
                                        sectionproperties.showwallet == 'Hide'
                                            ? 'none'
                                            : 'flex',
                                },
                            ]}
                        ...
                        >
                            ...
                            {sectionproperties.showtotalsection == 'Show' && <View style={{ width: '100%', backgroundColor: '#eee', height: 1, marginBottom: 10 }}></View>}
                            ...
                            {sectionproperties.showtotalsection == 'Show' && fetchorderhistoryQueryContext?.data?.data?.ordershistory[orderindex]?.haspromocode == 1 && (
                                <View style={[generalstyles.flexRow, { marginBottom: 5 }]}>
                                    <View style={{ width: 7, height: 7, borderRadius: 50, backgroundColor: sectionproperties.generaltext_fontColor, opacity: 0.2, marginEnd: 10 }}></View>
                                    <Text
                                        style={{
                            ...
                            {sectionproperties.hideshipping == 'Show' && (
                                <View style={[generalstyles.flexRow, { marginBottom: 5 }]}>
                                    ...
                                    >
                                        {langdetect == 'en' ? sectionproperties.shippingfeestitle_en : sectionproperties.shippingfeestitle_ar}: {/* {lang.shippingfees}:{' '} */}
                                    </Text>
                                    <Text
                                        style={{
                                            fontFamily:
                            ...
                            {/* cashback */}
                            {sectionproperties.showwallet == 'Show' && fetchorderhistoryQueryContext?.data?.data?.ordershistory[orderindex]?.usewalletpoints == 1 && (
                                <View style={[generalstyles.flexRow, { marginBottom: 5 }]}>
                                    <View style={{ width: 7, height: 7, borderRadius: 50, backgroundColor: sectionproperties.generaltext_fontColor, opacity: 0.2, marginEnd: 10 }}></View>
                                    <Text
                                        style={{
                                        ...
                                        style={{
                                            fontFamily:
                                                sectionproperties.generaltext_fontWeight == 300
                                                    ...
                                                    ? 'Poppins-Semibold'
                                                    : 'Poppins-Bold',
                                            color: sectionproperties.walletsecondarycolor,
                                            fontSize: StyleParseToIntFuncContext(sectionproperties.generaltext_fontSize),
                                        }}
                                    >
                                        {langdetect == 'en' ? fetchAuthorizationQueryContext.data.data.currencyname_en : ''}{' '}
                            ...
                            {fetchorderhistoryQueryContext?.data?.data?.ordershistory[orderindex]?.genpayments?.length != 0 &&
                                fetchorderhistoryQueryContext?.data?.data?.ordershistory[orderindex]?.genpayments?.map((item, index) => {
                                    return (
                                        <View style={[generalstyles.flexRow, { marginBottom: 5 }]}>
                                            <View style={{ width: 7, height: 7, borderRadius: 50, backgroundColor: sectionproperties.generaltext_fontColor, opacity: 0.2, marginEnd: 10 }}></View>
                                            <Text
                                                style={{
                                                    ...
                                                    color: sectionproperties.generaltext_fontColor,
                                                    fontSize: StyleParseToIntFuncContext(
                                                        sectionproperties.generaltext_fontSize != null && sectionproperties.generaltext_fontSize != undefined
                                                            ? sectionproperties.generaltext_fontSize
                                                            : 15,
                                                    ),
                    ...
                    <View
                        style={{
                            display: sectionproperties.hideaddress == 'Hide' && sectionproperties.hidecountrystatecity == 'Hide' ? 'none' : 'flex',
                        }}
                    >
                        <Text
                            style={[
                    ...
                    {/* )} */}
                    {fetchorderhistoryQueryContext?.data?.data?.ordershistory[orderindex]?.notes != null && (
                        <View>
                            <Text
                                style={[
                                    generalstyles.containerInner,
                    ...
                    {fetchorderhistoryQueryContext?.data?.data?.ordershistory[orderindex]?.owner_notes != null && (
                        <View>
                            <Text
                                style={[
                                    generalstyles.containerInner,
                                ...
                                return (
                                    <View style={{ flexDirection: 'column', padding: 10, paddingTop: index != 0 ? 0 : 10 }}>
                                        ...
                                        {index != fetchorderhistoryQueryContext?.data?.data?.ordershistory[orderindex]?.orderitems.length - 1 && (
                                            <View style={{ backgroundColor: sectionproperties.upperseparatorsecondarybgcolor, width: '100%', height: 1, marginTop: 10 }}></View>
                                        )}
