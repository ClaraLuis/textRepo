                            ...
                            <Collapse>
                                ...
                                >
                                    <View style={[generalstyles.flexRow]}>
                                            ...
                                            <Text
                                                style={[
                                                    generalstyles.poppinsMedium,
                                                    {
                                                        ...
                                                        fontSize: StyleParseToIntFuncContext(sectionproperties.filter_titlefontsize),
                                        ...
                                        {/* <AntDesign name="plus" size={18} color={sectionproperties.filter_titlecolor} /> */}
                                    </View>
                                </CollapseHeader>
                                <CollapseBody>
                                    <View style={[generalstyles.flexRow, generalstyles.allcentered, { display: 'flex', alignItems: 'flex-start', justifyContent: 'flex-start' }]}>
                                        <FlatList
                                            vertical
                                            data={item.parentcolletions}
                                            renderItem={(subparentcollectionitem) => {
                                                return (
                                                    <TouchableOpacity
                                                        style={[
                                                    ...
                                                    >
                                                        <View style={[{ width: '100%', height: 60 }]}>
                                                            {/* <Image
                                                                source={{ uri: urlEndpoint + subparentcollectionitem?.parentcollectionlogo }}
                                                                style={{
                                                                    width: '100%',
                                                                    height: '100%',
                                                                    borderRadius: 15,
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                asd {langdetect == 'en' ? subparentcollectionitem?.title_en : subparentcollectionitem?.title_ar}
                                                            </Text>
                                                        </View>
                                                    </TouchableOpacity>
                                                );
