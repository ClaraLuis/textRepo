...
import { MaterialIcons, FontAwesome, FontAwesome5, EvilIcons, Ionicons, Entypo } from '@expo/vector-icons';
                ...
                >
                    ...
                    <View
                        style={[
                            ...
                            {
                                marginTop: 5,
                                display: sectionproperties.showfavorites == 'Hide' && fetchAuthorizationQueryContext?.data?.data?.loggedin == false ? 'none' : 'flex',
                            },
                        ]}
                    >
                        <Text
                    ...
                    >
                        ...
                        >
                            ...
                            {fetchAuthorizationQueryContext?.data?.data?.loggedin && sectionproperties.showfavorites == 'Show' && (
                                <View style={{ width: '100%', height: 1, backgroundColor: sectionproperties.upperseparatorsecondarybgcolor, marginBottom: 10, marginTop: 10 }}></View>
                            )}
                            {sectionproperties.showfavorites == 'Show' && (
                                <TouchableOpacity
                                    style={{ flexDirection: 'row', marginTop: 5, marginBottom: 5 }}
                                    onPress={() => {
                    ...
                    <View style={[generalstyles.allcentered, { flexDirection: 'column', marginTop: 5 }]}>
                        ...
                        <View style={{ flexDirection: 'row', marginTop: 5 }}>
                            ...
                            {fetchAuthorizationQueryContext?.data?.data?.instinfo?.linkedinlink != null && (
                                <TouchableOpacity
                                    style={{
                                        flexDirection: 'row',
                                        marginTop: 10,
                                    ...
                                    onPress={() => {
                                        Linking.openURL(fetchAuthorizationQueryContext?.data?.data?.instinfo?.linkedinlink);
                                    }}
                                >
                                    <Entypo
                                        name="linkedin"
                            ...
                            {sectionproperties.showwebicon == 'Show' && fetchAuthorizationQueryContext?.data?.data?.instinfo?.instcred?.instexternaldomain != null && (
                                <TouchableOpacity
                                    style={{
                                        flexDirection: 'row',
                                        marginTop: 10,
                                    ...
                                    onPress={() => {
                                        Linking.openURL('https://' + fetchAuthorizationQueryContext?.data?.data?.instinfo?.instcred?.instexternaldomain);
                                    }}
                                >
                                    <MaterialCommunityIcons
                                        name="web"
