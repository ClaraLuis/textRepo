        ...
        return (
            ...
            >
                ...
                >
                    ...
                    {sectionproperties.showpill == 'Show' && item.hassale != 0 && (
                        <View
                            style={[
                                styles.hassalestyles,
                                generalstyles.allcentered,
                                {
                                    ...
                                    borderRadius: StyleParseToIntFuncContext(sectionproperties.pillborderBottomLeftRadius, '', true),
                                    borderWidth: StyleParseToIntFuncContext(sectionproperties.pillBorderWidth, '', true),
                            ...
                            style={[
                                {
                                    ...
                                    borderRadius: StyleParseToIntFuncContext(sectionproperties.fav_btn_borderBottomRightRadius),
                                },
                                generalstyles.allcentered,
                            ]}
                        >
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: sectionproperties.backgroundColortransparent == 'Transparent' ? 0 : 10 }}>
                    <View style={{ flexDirection: 'row', flex: 1, paddingEnd: sectionproperties.cartBtnShow == 'Show' ? 3 : 0 }}>
                        <View
                            style={{
                                width: '100%',
                            }}
                    ...
                    {sectionproperties.cartBtnShow == 'Show' && (
                        <TouchableOpacity
                            ...
                            style={[
                                {
                                    width: StyleParseToIntFuncContext(sectionproperties.cartBtnWidth != null && sectionproperties.cartBtnWidth != undefined ? sectionproperties.cartBtnWidth : 33),
