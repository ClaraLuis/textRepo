...
const Modernproductcardwithquantitybutton = (props) => {
    ...
    useEffect(() => {
        if (PendingQuantity != null) {
            // AddtoCartMutationContext.reset();
            const delayDebounceFn = setTimeout(() => {
                addtocartfunc('add', PendingQuantity);
    ...
    const cartbtn = () => {
        return (
            ...
            <View style={[{ flexDirection: 'row', marginTop: 10 }]}>
                        ...
                        style={[
                            {
                                ...
                                display: sectionproperties.showoutofstock == 'Show' && item.quantavailtype == 'limit' && item.hasvariants == 0 && item.currentquantity == 0 ? 'none' : 'flex',
                            },
                        ]}
                    >
                        <TouchableOpacity
                            ...
                            onPress={(e) => {
                                ...
                                if (item.hasvariants == 0) {
                                    ...
                                    setPendingQuantity(tempitem.quantity);
                                } else {
                        ...
                        <TouchableOpacity
                            ...
                            onPress={(e) => {
                                ...
                                if (item.hasvariants == 0) {
                                    ...
                                    setPendingQuantity(tempitem.quantity);
                                    // addtocartfunc('add', tempitem.quantity);
                                    // debouncedAddToCartFunc('add', tempitem.quantity);
                                } else {
                                    cardonclickfunctionContext(sectionproperties.onClickRoute, item.productid, props.fetchingtypeprops, item.collectionid);
                                }
                            }}
                ...
                {sectionproperties.showoutofstock == 'Show' && item.quantavailtype == 'limit' && item.hasvariants == 0 && item.currentquantity == 0 && (
                            ...
                            style={[
                                {
                                    ...
                                    opacity:
                                        sectionproperties.showoutofstock == 'Show' && item.quantavailtype == 'limit' && item.hasvariants == 0 && item.currentquantity == 0
                                            ? StyleParseToIntFuncContext(sectionproperties.outofstockimageopcity, '', true)
                                            : 1,
                                },
                            ]}
                        />
                    ...
                    <View style={[generalstyles.flexColumn, { paddingVertical: 10, paddingHorizontal: 12, paddingBottom: 0, width: '100%' }]}>
                        ...
                        {sectionproperties.prodCatShow == 'Show' && (
                            ...
                            >
                                ...
                                >
                                    {clip(langdetect == 'en' ? item.description_en : item.description_ar, 25, { html: true, stripTags: true })}
                                </ViewMoreText>
                            </View>
                        )}
                        ...
                        {sectionproperties.priceDirection == 'Vertical Direction' && (
                            <View style={{ flexDirection: 'row' }}>
                                <View style={{ flexDirection: 'column', width: '80%', alignItems: 'flex-start', marginTop: 4, height: 45 }}>
                                    {sectionproperties.prodsalePriceshow == 'Show' && item.defaultsaleprice != 0 && (
                                        <Text
                                            style={{
                                                color: sectionproperties.prodsalePriceColor,
    ...
    }, [sectionproperties, item.productid, item.quantity, AddtoCartMutationContext]);
    return cardsrender;
};
