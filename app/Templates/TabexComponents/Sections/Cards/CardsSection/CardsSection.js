...
const CardsSection = (props) => {
    ...
    const [searchvendorinput, setsearchvendorinput] = useState('');
        ...
        if (Object.keys(StatePageProperties).length != 0) {
            StatePageProperties?.pageobj?.sections?.forEach(function (sectionitem, sectionindex) {
                if (sectionitem.sectionid == props.sectionidprops) {
                    ...
                    if (props.srcfromprops == 'GeneralVendorComponent') {
                        ...
                        var tempProductsFetchingTypeSectionObj = { ...ProductsFetchingTypeSectionObj };
                        tempProductsFetchingTypeSectionObj.collectionid = props.collectionidprops;
                        setProductsFetchingTypeSectionObj({ ...tempProductsFetchingTypeSectionObj });
                    ...
                    if (props.srcfromprops == 'GeneralProductsComponent') {
                        ...
                        if (props.collectionidprops != undefined && props.collectionidprops != null) {
                            ...
                            tempProductFilterObjContext.collections = [props.collectionidprops];
                        }
    ...
    if (props.srcfromprops == 'GeneralVendorComponent') {
        useEffect(() => {
            ...
            var tempProductsFetchingTypeSectionObj = { ...ProductFilterObjContext };
            if (props.collectionidprops != undefined && props.collectionidprops != null && props.collectionidprops != '') {
                tempProductsFetchingTypeSectionObj.collections = props.collectionidprops;
            } else {
                tempProductsFetchingTypeSectionObj.collections = [];
            }
            if (props.price_minpassed != undefined && props.price_minpassed != null && props.price_minpassed != '' && props.price_minpassed != 'all') {
                tempProductsFetchingTypeSectionObj.price_min = props.price_minpassed;
            } else {
                tempProductsFetchingTypeSectionObj.price_min = 0;
            }
            if (props.price_maxpassed != undefined && props.price_maxpassed != null && props.price_maxpassed != '' && props.price_maxpassed != 'all') {
                tempProductsFetchingTypeSectionObj.price_max = props.price_maxpassed;
            } else {
                tempProductsFetchingTypeSectionObj.price_max = 1000000000000;
            }

            setProductFilterObjContext({ ...tempProductsFetchingTypeSectionObj });
                ...
                if (fetchingtype == 'collections') {
                    ...
                    if (fetchAuthorizationQueryContext?.isSuccess) {
                        ...
                        if (fetchingtype == 'innerparentcollections') {
                            if (props.collectionidprops != undefined && props.collectionidprops != null && props.collectionidprops != '' && props.collectionidprops != 'all') {
        ...
        if (fetchingtype.length != 0) {
            ...
            if (fetchingtype == 'products') {
                ...
                if (
                    ...
                    // tempfetchproductsfilerobjcontext.collections.push(ProductsFetchingTypeSectionObj.collectionid);
                    // if (
                    //     ProductsFetchingTypeSectionObj.collectionid != undefined &&
                    //     ProductsFetchingTypeSectionObj.collectionid != null &&
                    ...
                    if (
                        ...
                        var canaddcollection = true;
                        tempfetchproductsfilerobjcontext?.collections?.forEach(function (collocitem) {
                            if (collocitem == ProductsFetchingTypeSectionObj.collectionid) {
                                canaddcollection = false;
                            }
                        });
                        if (canaddcollection == true) {
                            tempfetchproductsfilerobjcontext.collections.push(ProductsFetchingTypeSectionObj.collectionid);
                        }
                    }
                }
                ...
                if (props.prod_featruesarpassed != undefined && props.prod_featruesarpassed != null && props?.prod_featruesarpassed?.length != 0) {
                    tempfetchproductsfilerobjcontext.prod_featruesar = props?.prod_featruesarpassed;
                }
    ...
    const cardobjassigner = (fetchedarray) => {
        ...
        fetchedarray?.forEach(function (arrayItem, arrayindex) {
            ...
            if (fetchingtype == 'products') {
                ...
                cardobj.status = arrayItem.status;
                if (arrayItem.promocodes != undefined && arrayItem.promocodes != null) {
                    cardobj.promocodes = arrayItem.promocodes;
                }
                cardobj.estimateddeliverytime = arrayItem.estimateddeliverytime;
            }
    ...
    //                 { height: sectionproperties.sliderstyle == 'Style 2' ? StyleParseToIntFuncContext(sectionproperties.sectiontitleheight) : 100, marginLeft: 'auto', marginRight: 'auto' },
    //             ]}
    //         >
    ...
    const generalproductsnavigation = () => {
        if (fetchingtype == 'products') {
            if (ProductsFetchingTypeSectionObj.productfetchingtype == 'Collection') {
            ...
            } else if (ProductsFetchingTypeSectionObj.productfetchingtype == 'Category') {
                navigation.navigate('TemplateDraftRouter', {
                    screen: StaticPagesLinksContext.GeneralProductsComponent,
                    params: {
                        genprodcompstinfo: {
                ...
                // routingcountext(StaticPagesLinksContext.GeneralProductsComponent, true, ProductsFetchingTypeSectionObj.collectionid);
                // alert(ProductsFetchingTypeSectionObj.collectionid);
            } else if (ProductsFetchingTypeSectionObj.productfetchingtype == 'Parent Collection') {
                navigation.navigate('TemplateDraftRouter', {
                    screen: StaticPagesLinksContext.GeneralProductsComponent,
                    params: {
                        genprodcompstinfo: {
            ...
            routingcountext(StaticPagesLinksContext.InnerParentCollection, {
                genprodcompstinfo: { collectionid: ProductsFetchingTypeSectionObj.collectionid, srcfrom: 'InnerParentCollection', fetchingtype: 'innerparentcollections' },
            });
        } else {
    ...
    const isCardsectionloading = () => {
        ...
        if (fetchingtype == 'products') {
            ...
            if (fetchAuthorizationQueryContext?.isFetching == true || fetchcollectionsQueryContext?.isFetching == true) {
                isloading = true;
            }
        }
    ...
    const SliderHorizontalSection = (sectioncomp, item, index) => {
        return (
            <View
                style={{
                    width: '100%',
                    paddingStart: sectionproperties.sliderstyle == 'Style 2' ? StyleParseToIntFuncContext(sectionproperties.paddingLeft) : 0,
                    paddingEnd: sectionproperties.sliderstyle == 'Style 2' ? StyleParseToIntFuncContext(sectionproperties.paddingRight) : 0,
                    marginBottom: sectionproperties.sliderstyle == 'Style 2' ? StyleParseToIntFuncContext(sectionproperties.marginBottom) : 0,
                    marginTop: sectionproperties.sliderstyle == 'Style 2' ? StyleParseToIntFuncContext(sectionproperties.marginTop) : 0,
                }}
            >
    ...
    useEffect(() => {
        if (fetchingtype == 'vendors') {
            const delayDebounceFn = setTimeout(() => {
                if (searchvendorinput != undefined) {
                    setProductFilterObjContext({ ...ProductFilterObjContext, searchvendorquery: searchvendorinput });
                }
            }, 500);
        ...
        return (
            <View
                style={{
                    ...
                    borderBottomLeftRadius: StyleParseToIntFuncContext(sectionproperties.sectionborderbottomtadius, '', true),
                    borderBottomRightRadius: StyleParseToIntFuncContext(sectionproperties.sectionborderbottomtadius, '', true),
                    borderTopLeftRadius: StyleParseToIntFuncContext(sectionproperties.sectionbordertoptadius, '', true),
                    borderTopRightRadius: StyleParseToIntFuncContext(sectionproperties.sectionbordertoptadius, '', true),
                ...
                {StatePageProperties?.pageobj?.sections[props.sectionindexprops]?.childsections?.map((item, index) => {
                    if (item.tabexsectioninfo != null) {
                        if (item.sectionstructype == 'child' && TabexSectionsComponentsContext[item.tabexsectioninfo.sectioncompname] != undefined) {
                            ...
                            return (
                                <>
                                    {sectionproperties.sliderstyle == 'Style 1' && (
                                        <View
                                            onPress={() => {
                                            ...
                                            style={[
                                                {
                                                    ...
                                                    paddingVertical: StyleParseToIntFuncContext(sectionproperties.sectiontitlepaddinghorizontal, '', true),
                                                    borderTopLeftRadius: StyleParseToIntFuncContext(sectionproperties.sectionbordertoptadius, '', true),
                                                    borderTopRightRadius: StyleParseToIntFuncContext(sectionproperties.sectionbordertoptadius, '', true),
                                                },
                                            ]}
                                    ...
                                    {sectionproperties.prodCatShow == 'Show' && sectionproperties.sliderstyle == 'Style 1' && (
                                        <View
                                            style={[
                                                generalstyles.flexRow,
                                                {
                                    ...
                                    {sectionproperties.viewmorebtnshow == 'Show' && sectionproperties.sectiontitleposition == 'Centered' && sectionproperties.sliderstyle == 'Style 1' && (
                                        <View style={[generalstyles.allcentered, { alignItems: 'center' }]}>{Viewmorebtn()}</View>
                                    )}
                                    {sectionproperties.showFilter == 'show' && sectionproperties.filterdirection == 'Horizontal' && sectionproperties.sliderstyle == 'Style 1' && (
                                        <View>
                                            <FilterHorizontal
                                                ProductFilterObjContext={ProductFilterObjContext}
                                                setProductFilterObjContext={setProductFilterObjContext}
                                                sectionproperties={sectionproperties}
                                                collid={ProductsFetchingTypeSectionObj.collectionid}
                                                propssrcfrom="cardssection"
                                            />
                                        </View>
                                    )}
                                    {fetchingtype == 'vendors' && sectionproperties.view_as_slider_vertical != 'Slider (Horizontal)' && sectionproperties.showvendorsearch == 'Show' && (
                                        <View>
                                            <View
                                                style={{
                                            ...
                                            >
                                                ...
                                                >
                                                    <TextInput
                                                        value={searchvendorinput}
                                                        onChangeText={(value) => {
                                                            setsearchvendorinput(value);
                                                        }}
                                                        style={[
                                    ...
                                    {/* {isCardsectionloading() && renderSpinner()} */}
                                    ...
                                    {sectionproperties.sliderstyle == 'Style 2' && (
                                        <View
                                            style={[
                                                generalstyles.flexRow,
                                                {
                                        ...
                                        >
                                            {sectionproperties.sectiontitleshow == 'Show' && sectionproperties.viewmorebtnshow == 'Show' && (
                                                <TouchableOpacity
                                                    style={[
                                                        generalstyles.allcentered,
                                                        {
                                                            width: StyleParseToIntFuncContext(sectionproperties.sectiontitlewidth),
                                                            height: StyleParseToIntFuncContext(sectionproperties.sectiontitleheight),
                                                            borderTopEndRadius: StyleParseToIntFuncContext(sectionproperties.sectiontitleborderradius, '', true),
                                                            borderBottomEndRadius: StyleParseToIntFuncContext(sectionproperties.sectiontitleborderradius, '', true),
                                                            backgroundColor: sectionproperties.sectiontitlebgcolor,
                                                            position: 'absolute',
                                                            left: 0,
                                                            zIndex: 1000,
                                                ...
                                                >
                                                    <Text
                                                        style={{
                                                            ...
                                                            width: StyleParseToIntFuncContext(sectionproperties.sectiontitleheight),
                                                            textAlign: 'center',
                                                        }}
                                                        ellipsizeMode="tail"
                                                        numberOfLines={2}
                                            ...
                                            {sectionproperties.sectiontitleshow == 'Show' && sectionproperties.viewmorebtnshow == 'Hide' && (
                                                <View
                                                    style={[
                                                        generalstyles.allcentered,
                                                        {
                                            ...
                                            {SliderHorizontalSection(sectioncomp, item, index)}
                                        </View>
                                    )}
                                    <View
                                        style={{
                                    ...
                                    >
                                        {sectionproperties.sliderstyle == 'Style 1' && SliderHorizontalSection(sectioncomp, item, index)}
                                        {sectionproperties.view_as_slider_vertical != 'Slider (Horizontal)' && (
                                            <View
                                                style={{
                                                    display: 'flex',
                                                    ...
                                                    <FlatList
                                                        ...
                                                        key={
                                                            SIZES.width > 768 && item.tabexsectioninfo.sectioncompname == 'CTAProductCard'
                                                                ...
                                                                ? 3
                                                                : SIZES.width > 768 && item.tabexsectioninfo.sectioncompname == 'HorizontalCategoryCard'
                                                                ? 3
                                                                : SIZES.width > 768
                                                                ? 4
                                                                ...
                                                                ? 3
                                                                : item.tabexsectioninfo.sectioncompname == 'ClassicCategoryCard' || item.tabexsectioninfo.sectioncompname == 'ChiqueCard'
                                                                ? sectionproperties.numberOfColsvertical
                                                                : SIZES.width > 768 && item.tabexsectioninfo.sectioncompname == 'HorizontalCategoryCard'
                                                                ? 3
                                                                : item.tabexsectioninfo.sectioncompname == 'HorizontalCategoryCard'
                                                                ? sectionproperties.numberOfColsvertical
                                                                : item.tabexsectioninfo.sectioncompname == 'Productcard_withroundedbg'
                                                                ? sectionproperties.numberOfColsvertical
                                                                : item.tabexsectioninfo.sectioncompname == 'Cardwithblureffect'
                                                                ? sectionproperties.numberOfColsvertical
                                                                : 2
                                                        }
                                                        numColumns={
    ...
    }, [cardsarray, props, props.vendorsarrpassed, isproductsfetching, ProductFilterObjContext, searchvendorinput]);
    return (
        <View
            style={{
                backgroundColor: sectionproperties.outerbgcolor,
                height: cardsarray.length == 0 && sectionproperties.sliderstyle == 'Style 2' ? StyleParseToIntFuncContext(sectionproperties.sectiontitleheight) : 'auto',
        ...
        >
            {/* <Text>{JSON.stringify(FetchVendorsQuery?.data?.data?.vendors)}</Text> */}
