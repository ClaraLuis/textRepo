...
export const LanguageProvider = (props) => {
    const [langdetect, setlangdetect] = useState('en');
    const [lang, setlang123] = useState({});
    const [langdic, setlangdict] = useState({
        en: {
            ...
            pleasecompleteaddressmissingfields: 'Please complete the missing address fields',
    ...
    useEffect(() => {
        if (langdetect == 'en') {
            setlang123(langdic['en']);
            I18nManager.allowRTL(false);
            I18nManager.forceRTL(false);
        } else if (langdetect == 'ar') {
            setlang123(langdic['ar']);
            I18nManager.allowRTL(true);
            I18nManager.forceRTL(true);
        }
    }, [langdetect]);
